...
/*
|
| Extend cache driver to support SASL auth
|
*/
if (Config::get('cache.driver') == 'memcachedsasl'){
  Cache::extend('memcachedsasl', function()
  {
    return new MemcacheSASLDriver(Config::get('cache.key'));
  });
}