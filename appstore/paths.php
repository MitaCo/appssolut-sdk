...
$environments = array(
    'local' => array('http://localhost*', 'http://appssolut.dev', 'http://appssolut.dev:8000'),
    'dev' => array('dev-appssolut.*', 'dev.*', 'demo.appssolut.com'),
    'staging' => array('staging.*', 'staging-appssolut.*'),
    'production' => array('appssolut.cloudcontrolled.com', 'www.*')
);
