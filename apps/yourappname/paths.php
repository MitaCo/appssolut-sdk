...
$environments = array(
    'local' => array('http://localhost*', 'http://appssolut.dev*'),
    'dev' => array('dev-appssolut.*', 'dev.*'),
    'staging' => array('staging.*', 'staging-appssolut.*'),
    'production' => array('appssolut.cloudcontrolled.com')
);

require('application/config/appssolut.php');
// --------------------------------------------------------------
...
// --------------------------------------------------------------
$paths['public'] = '../../public/apps/'.APPSOLUTE_FOLDER.'';
